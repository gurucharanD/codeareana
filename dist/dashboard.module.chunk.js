...
var DashboardComponent = (function () {
    function DashboardComponent(queService, fb, _loginService, router, authService, quiz) {
    ...
    DashboardComponent.prototype.showQuestionForWeek = function () {
        ...
        this._loginService.getAnsweredQuestions(query)
            ...
            console.log(_this.answeredQuestions);
